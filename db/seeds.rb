...
Municipality.create(municipality_name: '秋田市', municipality_name_kana: 'アキタシ', prefecture_id: '5')
Municipality.create(municipality_name: '能代市', municipality_name_kana: 'ノシロシ', prefecture_id: '5')
Municipality.create(municipality_name: '横手市', municipality_name_kana: 'ヨコテシ', prefecture_id: '5')
Municipality.create(municipality_name: '大館市', municipality_name_kana: 'オオダテシ', prefecture_id: '5')
Municipality.create(municipality_name: '男鹿市', municipality_name_kana: 'オガシ', prefecture_id: '5')
Municipality.create(municipality_name: '湯沢市', municipality_name_kana: 'ユザワシ', prefecture_id: '5')
Municipality.create(municipality_name: '鹿角市', municipality_name_kana: 'カヅノシ', prefecture_id: '5')
Municipality.create(municipality_name: '由利本荘市', municipality_name_kana: 'ユリホンジョウシ', prefecture_id: '5')
Municipality.create(municipality_name: '潟上市', municipality_name_kana: 'カタガミシ', prefecture_id: '5')
Municipality.create(municipality_name: '大仙市', municipality_name_kana: 'ダイセンシ', prefecture_id: '5')
Municipality.create(municipality_name: '北秋田市', municipality_name_kana: 'キタアキタシ', prefecture_id: '5')
Municipality.create(municipality_name: 'にかほ市', municipality_name_kana: 'ニカホシ', prefecture_id: '5')
Municipality.create(municipality_name: '仙北市', municipality_name_kana: 'センボクシ', prefecture_id: '5')
Municipality.create(municipality_name: '小坂町', municipality_name_kana: 'コサカマチ', prefecture_id: '5')
Municipality.create(municipality_name: '上小阿仁村', municipality_name_kana: 'カミコアニムラ', prefecture_id: '5')
Municipality.create(municipality_name: '藤里町', municipality_name_kana: 'フジサトマチ', prefecture_id: '5')
Municipality.create(municipality_name: '三種町', municipality_name_kana: 'ミタネチョウ', prefecture_id: '5')
Municipality.create(municipality_name: '八峰町', municipality_name_kana: 'ハッポウチョウ', prefecture_id: '5')
Municipality.create(municipality_name: '五城目町', municipality_name_kana: 'ゴジョウメマチ', prefecture_id: '5')
Municipality.create(municipality_name: '八郎潟町', municipality_name_kana: 'ハチロウガタマチ', prefecture_id: '5')
Municipality.create(municipality_name: '井川町', municipality_name_kana: 'イカワマチ', prefecture_id: '5')
Municipality.create(municipality_name: '大潟村', municipality_name_kana: 'オオガタムラ', prefecture_id: '5')
Municipality.create(municipality_name: '美郷町', municipality_name_kana: 'ミサトチョウ', prefecture_id: '5')
Municipality.create(municipality_name: '羽後町', municipality_name_kana: 'ウゴマチ', prefecture_id: '5')
